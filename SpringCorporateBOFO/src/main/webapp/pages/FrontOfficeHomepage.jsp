...
<body>
  ...
  <sql:setDataSource var="dbsource" driver="com.mysql.cj.jdbc.Driver"
        ...
        <sql:query dataSource="${dbsource}" var="result">
            SELECT a.CorporateId,a.AccountNumber,a.AccountName,a.Currency,a.Branch,a.AvBalance,a.Status from Account a inner join UserSetup u on a.CorporateId=u.CorporateId where u.UserID=?;
...
<div class="mainpage">
 ...
 <center> <h2>List Of Accounts</h2></center> <br>
   ...
   <td><a style="color:blueviolet;" href="viewAccountDetails?accountNumber=<c:out value="${c.AccountNumber}" />">Details</a></td>
