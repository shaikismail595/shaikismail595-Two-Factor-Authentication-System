...
<body>
 <sql:setDataSource var="dbsource" driver="com.mysql.cj.jdbc.Driver"
    ...
    <div class="operation">
       ...
       <button style="margin-left:20px;padding:10px 50px;color:white;"><a style="font-weight:bold;font-size:30px " href="AddnewUser?corporateId=<c:out value="${c.CorporateId}" />"> <c:out value="${c.CorporateName}" /></a> </button>
      <br><br>
       </c:forEach>
</body>
</html>