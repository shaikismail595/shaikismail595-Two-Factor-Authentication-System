...
<body>
 <sql:setDataSource var="dbsource" driver="com.mysql.cj.jdbc.Driver"
   ...
   <select style="padding:3px 20px;font-size:18px""><option><c:out value="${c.CorporateName}"/></option>
   <table border="1" width="144" style="margin-left:2%">
   <option><tr><th>CorporateId &nbsp</th><th>&nbsp UserId &nbsp</th><th>&nbsp password &nbsp</th><th>&nbsp Department &nbsp</th><th>&nbsp Address &nbsp</th><th>&nbsp Phone</th></tr></option>
   <c:forEach var="c1" items="${result2.rows}">
  <option> <tr>
   <td><c:out value="${c1.CorporateId}"/></td>
   <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<c:out value="${c1.UserID}"/></td>
   <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<c:out value="${c1.UserPassword}"/></td>
