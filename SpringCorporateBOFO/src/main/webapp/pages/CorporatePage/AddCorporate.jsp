...
<body>
    ...
    <div class="operation" style="z-index: 1">
        <form action="addCorporate" modelAttribute="cor" method="post">
            ...
            <td>Phone Number: <input type="tel"name="PhoneNumber" maxlength="10" id="phoneNumber" required/></td></tr><br><br>
